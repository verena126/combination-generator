...
public class CombinationGeneratorTest {
    ...
    private CombinationGeneratorNew cg7;
    ...
    void testFirstElementsForSizeThree() {
        ...
        var a3_5 = cg3.generate();
        assertThat(a3_5).contains(3, 1, 2);
        var a3_6 = cg3.generate();
        assertThat(a3_6).contains(3, 2, 1);
        var a3_7 = cg3.generate();
    ...
    void testFirstElementsForSizeSix() {
        ...
        var a6_4 = cg6.generate();
        assertThat(a6_4).contains(1, 2, 3, 5, 6, 4);
        var a6_5 = cg6.generate();
    ...
    void testGenerateWithTwoElements() {
        ...
        assertThat(tryFind(new int[]{32, 1})).isTrue();
        assertThat(tryFind(new int[]{8, 15})).isTrue();
        assertThat(tryFind(new int[]{12, 2})).isTrue();
        assertThat(tryFind(new int[]{11, 15})).isTrue();
        assertThat(tryFind(new int[]{23, 12})).isTrue();
        assertThat(tryFind(new int[]{1, 18})).isTrue();
    ...
    void testGenerateWithThreeElements() {
        ...
        assertThat(tryFind(new int[]{5, 1, 2})).isTrue();
        assertThat(tryFind(new int[]{6, 19, 16})).isTrue();
        ...
        assertThat(tryFind(new int[]{7, 10, 11})).isTrue();
        ...
        assertThat(tryFind(new int[]{100, 19, 16})).isTrue();
    }
    ...
    void testGenerateWithThreeElementsNegative()  {
        ...
        assertThat(tryFind(new int[]{14, 14, 33})).isFalse();
    ...
    void testGenerateWithFourElements()  {
        ...
        assertThat(tryFind(new int[]{3, 2, 11, 14})).isTrue();
        ...
        assertThat(tryFind(new int[]{5, 2, 1, 6})).isTrue();
        ...
        assertThat(tryFind(new int[]{14, 5, 1, 2})).isTrue();
        assertThat(tryFind(new int[]{1, 4, 13, 3})).isTrue();
        assertThat(tryFind(new int[]{6, 16, 26, 36})).isTrue();
        assertThat(tryFind(new int[]{2, 24, 26, 28})).isTrue();
        assertThat(tryFind(new int[]{3, 1, 5, 23})).isTrue();
        assertThat(tryFind(new int[]{7, 2, 3, 13})).isTrue();
        assertThat(tryFind(new int[]{8, 3, 11, 2})).isTrue();
        assertThat(tryFind(new int[]{6, 2, 1, 5})).isTrue();
        assertThat(tryFind(new int[]{7, 1, 5, 23})).isTrue();
    ...
    void testGenerateWithFiveElements()  {
        ...
        assertThat(tryFind(new int[]{2, 5, 6, 3, 1})).isTrue();
